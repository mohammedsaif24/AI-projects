...
def run_model(input):
    ...
    """ changing the execution provider to OpenVINO"""
    model = ort.InferenceSession("yolov8m.onnx", providers=['OpenVINOExecutionProvider'], provider_options=[{'device_type': 'CPU_FP32'}])
